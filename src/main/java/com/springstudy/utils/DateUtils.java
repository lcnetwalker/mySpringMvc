...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
    ...
    public static final SimpleDateFormat date_sdf_MM_dd = new SimpleDateFormat(
            "MM-dd");
    // 各种时间格式
    ...
    public static long getQuot(Date begin, Date end) {
        ...
        try {
            ...
            quot = (end.getTime() - begin.getTime()) / (1000 * 3600 * 24);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return quot;
    ...
    public static void main(String[] args) {
        long quot = getQuot("2014-11-28", "2015-05-01");
