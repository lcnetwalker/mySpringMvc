	...
	<div class="portlet-body" style="display:;">
		<div class=" form-body form-horizontal">
			...
			<div class="form-group">
				...
				<a href="#" style="padding: 6px" class="Cselect " onclick="layerArea()" onmouseover="$(this).tooltip('show')" data-toggle="tooltip" title="" data-placement="top" data-original-title="点击选择"><img src="${ctx }/assets/img/click.png"></a>				
				</div> --%>
			</div>
		</div>
	</div>
