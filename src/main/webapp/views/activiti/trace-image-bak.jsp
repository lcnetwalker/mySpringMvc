...
<link href="${ctx}/assets/js/qtip/jquery.qtip.min.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${ctx }/assets/js/qtip/jquery.qtip.min.js"></script>
