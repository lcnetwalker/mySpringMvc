...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${ctx }/static/assets/plupload-2.1.2/js/jquery.plupload.queue/css/jquery.plupload.queue.css">
</head>
<body>
...
<content tag="myJavascript">
    <script src="${ctx }/static/assets/activiti/date.js"/>
    <script src="${ctx }/static/assets/scripts/json_parse.js"></script>
    <script src="${ctx }/static/assets/plupload-2.1.2/js/plupload.full.min.js"></script>
    <script src="${ctx }/static/assets/plupload-2.1.2/js/jquery.plupload.queue/jquery.plupload.queue.min.js"></script>
    <script src="${ctx }/static/assets/plupload-2.1.2/js/i18n/zh_CN.js"></script>
    <script type="text/javascript" src="${ctx}/static/assets/plugins/ckeditor/ckeditor.js"></script>
