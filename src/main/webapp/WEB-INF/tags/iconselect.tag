...
<span id="${id}Button"  class="input-group-addon btn "><a href="javascript:"><i
			class="fa fa-search-plus"></i></a></span></div>
<script type="text/javascript">
	$("#${id}Button").click(function(){
		top.$.jBox.open("iframe:${ctx}/tags/iconselect?value="+$("#${id}").val(), "选择图标", 620, $(top.document).height()-240, {
