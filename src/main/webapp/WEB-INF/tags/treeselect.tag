...
<div class="input-group ">
	...
	<input id="${id}Name" name="${labelName}"
		readonly="readonly" type="text" value="${labelValue}"
		class="form-control ${cssClass}" style="${cssStyle}" />	
		<span class="input-group-addon default btn ${disabled} form-inline" href="javascript:" id="${id}Button"><i
...
<script type="text/javascript">
    $("#${id}Button").click(function(){
        ...
        // 正常打开
        top.$.jBox.open("iframe:${ctx}/tags/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&selectIds="+$("#${id}Id").val()+"&rsfw="+$("#49Id").val(), "选择${title}", 300, 420, {
